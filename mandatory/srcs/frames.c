...
#define MOVE_SPEED     0.01    // player speed per frame
#define ROT_SPEED      0.005    // rotation speed per frame (in radians)
...
int main()
{
    ...
    // Initialize your map, player position, direction, etc.
    init_game(&data);
